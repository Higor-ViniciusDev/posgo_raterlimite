...
func NewPolicyUsecase(expire expire_usecase.ExpirerInterface, tolkenRepository tolken_entity.TolkenRepositoryInterface, requestInfo request_entity.RequestRepository) *PolicyUsecase {
